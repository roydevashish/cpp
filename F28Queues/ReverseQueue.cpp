...
Output queue:alignas
Front -> 90 | 80 | 70 | 60 | 50 | 40 | 30 | 20 | 10 <- Rear

Detailed explanation ( Input/output format, Notes, Images )
Input Format:
The first list of input contains an integer 't' denoting the number of test cases/queries to be run.
Then the test cases follow.
    - The first line input for each test case/query contains an integer N, denoting the total number 
...
make the changes in the input queue itself.
